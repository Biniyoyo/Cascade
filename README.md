...
| 5 friction issues found while building (incident priority enum coercion, undocumented write headers, unbounded lineage payloads, missing incident write tools, custom-assertion UI surfacing) | mcp-server-datahub · datahub | **[#18709](https://github.com/datahub-project/datahub/issues/18709) — FIXED UPSTREAM** by maintainer PR [#18738](https://github.com/datahub-project/datahub/pull/18738) (merged). [#18711](https://github.com/datahub-project/datahub/issues/18711) — **we closed it ourselves** after failing to reproduce it on a clean quickstart (the assertion was statusless only until our runner reported a result; write-up in the thread). Open: [#153](https://github.com/acryldata/mcp-server-datahub/issues/153), [#154](https://github.com/acryldata/mcp-server-datahub/issues/154), [#18710](https://github.com/datahub-project/datahub/issues/18710) |
